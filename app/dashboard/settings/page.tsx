  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 space-y-8"> 
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="mt-1 px-3 py-2 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-900 dark:text-gray-100">{user?.firstName}</p>
            </div>
            <div>
              <Label className="text-sm font-medium text-gray-700 dark:text-gray-200">Last Name</Label>
              <p className="mt-1 px-3 py-2 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-900 dark:text-gray-100">{user?.lastName}</p>
            </div>
          </div>

          <div>
            <Label className="text-sm font-medium text-gray-700 dark:text-gray-200">Email</Label>
            <p className="mt-1 px-3 py-2 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-900 dark:text-gray-100 break-words">{user?.email}</p>
          </div>

          <div>
            <Label className="text-sm font-medium text-gray-700 dark:text-gray-200">Role</Label>
            <p className="mt-1 px-3 py-2 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-900 dark:text-gray-100">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-700">
            <div>
              <p className="font-medium text-gray-900">SMS Notifications</p>
              <p className="text-sm text-gray-600 dark:text-gray-300">Receive SMS notifications for important events</p>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-700">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Receive email notifications for system updates</p>
            </div>
            <label className="flex items-center cursor-pointer">
              <input
                type="checkbox"
